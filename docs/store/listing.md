# Store listing — Tiny POS

Thông tin điền vào Google Play Console / App Store Connect khi nộp kiểm duyệt.

## Thông tin chung
- **Tên app / App name:** Tiny POS
- **Subtitle (iOS, ≤30 ký tự):** Bán hàng cho quán cà phê
- **Android applicationId:** `com.tinypos.tiny_pos_mobile`
- **iOS bundle id:** `com.tinypos.tinyPosMobile`
...
## Mô tả đầy đủ (Play / iOS)
Tiny POS là ứng dụng bán hàng (POS) gọn nhẹ cho quán và chuỗi cà phê, thiết kế cho thao
tác nhanh trên điện thoại.

✦ **Thu ngân** — Bán hàng tại quầy & tại bàn, chọn size/đường/đá/topping, tìm món nhanh,
áp khuyến mãi, thanh toán (tiền mặt/chuyển khoản/thẻ/ví), in bill và đẩy đơn lên màn pha chế.

✦ **Màn hình pha chế (KDS)** — Hàng chờ real-time theo FIFO, đếm thời gian, cảnh báo đơn
trễ, tick từng món và hoàn thành đơn.
...
|---|---|---|
| App icon | 512×512 (Play) / 1024×1024 (iOS) | ✅ `assets/icon/icon.png` (1024) đã tạo |
| Adaptive icon | foreground 1024 + bg #241008 | ✅ đã sinh |
| Feature graphic (Play) | 1024×500 | ✅ `assets/store/feature_graphic.png` |
| Screenshots điện thoại | ≥2 ảnh, tỉ lệ 9:16 | ⏳ chụp từ app (xem checklist) |
